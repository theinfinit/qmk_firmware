...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        MO(4),   LALT_T(KC_A), LSFT_T(KC_S), LCTL_T(KC_D), LGUI_T(KC_F), KC_G,  KC_H,  RGUI_T(KC_J), RCTL_T(KC_K), RSFT_T(KC_L), RALT_T(KC_SCLN), KC_QUOT, KC_ENT, \
        KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,  KC_N,  KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         KC_RSFT,                            KC_UP, \
        KC_LCTL, KC_LGUI, MO(3),                                         KC_SPC,                                   KC_RALT,      MO(2),           KC_APP,  KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [1] = LAYOUT(
    ...
    [3] = LAYOUT(
        ...
        _______,      LALT(KC_A), LSFT_T(KC_S), KC_LPRN, KC_RPRN, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_BSLS, KC_GRV,  KC_TILD, _______, \
        _______,      _______,    _______,      _______, KC_UNDS, _______, KC_EQL,  KC_LBRC, KC_RBRC, _______, _______, _______,                             _______, \
