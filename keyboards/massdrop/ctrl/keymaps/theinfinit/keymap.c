...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT(
        ...
        _______, _______,         KC_PGDN,      LCTL(KC_LEFT), LCTL(KC_RGHT), KC_PGUP, VIM_Y,   LCTL(KC_Z), KC_HOME, KC_END,   LSFT(KC_INS), _______,  _______, _______,    _______, _______, _______, \
        _______, LALT_T(KC_INS),  LSFT_T(KC_S), KC_DEL,        KC_BSPC,       VIM_G,   KC_LEFT, KC_DOWN,    KC_UP,   KC_RGHT,  KC_ENT,       NEW_LINE, _______, \
        _______, COPY_ALL,        VIM_D,        VIM_C,         _______,       _______, _______, _______,    _______, _______,  _______,      _______,                                _______, \
        _______, _______,         _______,                                             _______,                      _______,  _______,      _______,  _______,             _______, _______, _______ \
    ), 
    [_VIM_YANK] = LAYOUT(
        _______, _______,  _______, _______,             _______,   _______, _______,             _______,             _______,           _______,     _______, _______, _______,           _______, _______, _______, \
    ...
    [_VIM_DELETE] = LAYOUT(
        ...
        _______, DELETE_ALL, _______,     _______,               _______,     _______, DELETE_WORD_BACKWARDS, DELETE_TWO_LINES_DOWN, DELETE_TWO_LINES_UP, DELETE_WORD, _______, _______, _______,
        _______, _______,    DELETE_LINE, _______,               _______,     _______, DELETE_TO_BOL,         _______,               _______,             _______,     _______, _______,                             _______, \
        _______, _______,    _______,                                                  _______,                                                           _______,     _______, _______, _______,           _______, _______, _______ \
    ),
    [_VIM_CHANGE] = LAYOUT(
        _______, _______, _______, _______,            _______,  _______, _______,            _______,            _______,          _______,  _______, _______, _______,           _______, _______, _______, \
        ...
        _______, CUT_ALL, _______, KC_NO,              _______,  _______, CUT_WORD_BACKWARDS, CUT_TWO_LINES_DOWN, CUT_TWO_LINES_UP, CUT_WORD, _______, _______, _______,
