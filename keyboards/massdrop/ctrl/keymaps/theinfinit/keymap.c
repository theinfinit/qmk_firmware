...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT(
        ...
        _______, LALT_T(KC_INS),  LSFT_T(KC_S), KC_DEL,         KC_BSPC,       VIM_G,   KC_LEFT, KC_DOWN,    KC_UP,   KC_RGHT,  KC_ENT,       _______, _______, \
        _______, COPY_ALL,        VIM_D,       VIM_C,         _______,       _______, KC_HOME, _______,    _______, _______,  _______,      _______,                               _______, \
        _______, _______,         _______,                                             _______,                      _______,  _______,      _______, _______,             _______, _______, _______ \
    ), 
    [_VIM_YANK] = LAYOUT(
        _______, _______,  _______, _______,             _______,   _______, _______,             _______,             _______,           _______,     _______, _______, _______,           _______, _______, _______, \
