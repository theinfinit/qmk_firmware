...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        MO(5),   LALT_T(KC_A), LSFT_T(KC_S), LCTL_T(KC_D), LGUI_T(KC_F), KC_G,  KC_H,  RGUI_T(KC_J), RCTL_T(KC_K), RSFT_T(KC_L), RALT_T(KC_SCLN), KC_QUOT, KC_ENT, \
        KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,  KC_N,  KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         KC_RSFT,                            KC_UP, \
        KC_LCTL, KC_LGUI, MO(3),                                         LT(4,KC_SPC),                             KC_RALT,      MO(2),           KC_APP,  KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [1] = LAYOUT(
    ...
    [3] = LAYOUT(
        ...
        _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, _______, _______,  _______, _______, _______, \
        _______, _______, _______, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_BSLS, _______, _______, _______, \
    ...
    [5] = LAYOUT(
        ...
        _______, _______, KC_LSFT,    KC_DEL,        KC_BSPC,       LCTL(KC_BSPC), KC_LEFT, KC_DOWN,    KC_UP,   KC_RGHT, _______, _______, _______, \
