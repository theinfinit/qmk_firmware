...
[_PLOVER] = LAYOUT_planck_grid(
    KC_TAB,  KC_1,    KC_1,    KC_1,    KC_1,    KC_1,    KC_1,    KC_1,    KC_1,    KC_1,    KC_1,    KC_1   ,
...
_______, _______, _______,  _______, _______, _______, _______, KC_AMPR, KC_ASTR, KC_TILD, KC_ASTR, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    _______, ALT_F4,  _______, _______, _______, _______, KC_UNDS, _______, _______, _______, _______, _______,
...
[_NAV] = LAYOUT_planck_grid(
    _______, LALT_T(KC_INS), KC_PGDN,            LCTL(KC_LEFT), LCTL(KC_RGHT), KC_PGUP,    LCTL(KC_INS), LCTL(KC_Z),   KC_HOME,       KC_END,  LSFT(KC_INS), _______, 
